...
export default {
  ...
  methods: {
    ...
    beforeSendData() {                                       // Delete old node path and run sendData()
        this.axios.get('https://fibermap-api.cmu.ac.th/deletenodepath', {
            params: {
    ...
    sendData() {                                       // send data to DB
      ...
      this.axios.post('https://fibermap-api.cmu.ac.th/addnodepath', {
        ...
        .then(function (response) {
            ...
            alert('Edited node path success.')
    ...
    getNodePath () {                                       // Get old node path from DB
        this.axios.get('https://fibermap-api.cmu.ac.th/getnodepathedit', {
        params: {
            line_id: this.$route.params.id
        },
        headers: {'Authorization': sessionStorage.getItem('token')}
